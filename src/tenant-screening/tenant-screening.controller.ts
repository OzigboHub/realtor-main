...
import { TenantScreeningService, ApplyTenantScreeningDto } from './tenant-screening.service';
...
export class TenantScreeningController {
  ...
  @Post('apply')
  @ApiOperation({ summary: 'Apply for 1-Click AI Tenant Screening & Risk Scoring' })
  async apply(
    @CurrentUser() user: any,
    @Body() dto: ApplyTenantScreeningDto,
  ) {
  ...
  @ApiOperation({ summary: 'Get all tenant screening applications for landlord/caretaker' })
